...
\section{Hra}
reprezentovana tridou game

te je predan konstruktorem herni stav a konkretni ecsfactory

pomoci konkretni ecsfactory si hra vyvari tridy z abstrackni vrstvy se kterou pracuje

obrazek

\subsection{Herní stavy}
hra se sklada z herních stavu

kazdý reprezentuje herní obrazovku

vzdycky pouze jeden aktivni

herní stav obsahuje ecsworld, kameru a UILayer

Take obsahuje systemy

kazdy herni stav dedi z abstraktni tridy GameState, je nutne implementovat metody pro vytvareni UI, entit a systemu

\subsection{LevelState}
Jedna se o herni stav, ktery obsahuje core hry

pro vytvareni entit pouziva levelfactory, pro vytvarei herniho sveta pouziva gameworld generator, herni svet je reprezentovat gameworld

\subsection{Herní mechaniky}
v systemech a komponntach

ty jsou tady a tady

\subsection{Herní data}
co to je a proc to je potreba

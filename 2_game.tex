...
Každý vesničan má také hlad. Pokud hlav vesničana bude příliš velký, tak vesničan zemře. Pokud hlad vesničana klesne pod určitou hodnotu a ve skladišti dané vesnice se bude nacházet \textit{jídlo} tak vesničan dojde ke skladišti a hlad si naplní snezenim jídla.

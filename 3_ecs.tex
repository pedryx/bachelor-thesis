...
Tomuto objektu se v ECS implementacích běžně říká query. Pro jeho vytvoření je většinou nutné poskytnou informaci, nad jakými typy komponent bude query pracovat. Je například možné mít query, které pracuje nad komponenty \verb|Movement| a \verb|Position|. Takové query by pak bylo schopné iterovat nad všemi entitami co mají komponenty \verb|Movement| a \verb|Position|. Pomocí tohoto query by bylo možné implementovat \verb|MovementSystem|, který by řídil logiku pohybu.

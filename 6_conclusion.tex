...
\begin{enumerate}
    ...
    % oduvodnit jak ho odstranit
    % odpoved na proc jsme ho neodrstranili
    % co s tim, jak se k tomu stavime, co bychom museli zkoumat/prozkoumat
    % napr naznacit ze ten problem neni trivialni
    % co by priblizne znamenalo ten problem odstranit
    ...
    % tady take, napr ono to moc jinak nejde nebo neco takoveho
    % nejak se k tomu postavit
    % nejak to nevadi nebo neco bychom s tim chteli udelat do budoucna
\end{enumerate}

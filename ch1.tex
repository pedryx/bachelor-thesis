...
\xxx{Příklad návrhu příliš dlouhý?}\\
\xxx{Více a logičtěji popsat proč dědičnost bad.}
...
\xxx{Princip composition over inheritance byl již zmíněný v gang of four -- legendarní knížce o OOP a dá se říct, že příliš veliké a složité hiearchie dědičnosti jsou v OOP špatnou praktikou.}
...
\xxx{Více čtení o nevýhodách OOP a Component pattern -- https://gameprogrammingpatterns.com/component.html}

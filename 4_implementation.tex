...
\texttt{BehaviorSystem} se stará o chování vesničanů. Ze sekce~\ref{sec:ai} víme, že pro chování vesničanů používáme \textit{strom chování}. Každý vesničan má právě jeden \textit{strom chování} a \texttt{BehaviorSystem} pouze volá metodu \textit{Tick} na daném \textit{stromu chování}, která jej zpracovává.

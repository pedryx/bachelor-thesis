...
\include{1_intro}
\include{2_architecture}
\include{3_ecs}
\include{4_game_requirments}
\include{5_game_specification}
\include{6_hypothesis}
\include{7_implementation_analysis}
\include{8_implementation}
\include{9_benchmark_analysis}
\include{10_results}

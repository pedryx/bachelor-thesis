...
Je nutné zmínit, že tyto články jsou již starší a pro moderní C\# jsou pravidla pro inlinování méně přísná. Například překladač je schopný v některých případech provést \textit{inlinování funkce} i přes to, že se jedná o virtuálního volání funkce.
